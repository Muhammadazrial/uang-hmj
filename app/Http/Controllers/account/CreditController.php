...
class CreditController extends Controller
{
    ...
    public function index()
    {
        $credit = DB::table('pengeluaran')
            ->select('pengeluaran.id', 'pengeluaran.category_id', 'pengeluaran.user_id', 'pengeluaran.nominal', 'pengeluaran.credit_date', 'pengeluaran.description', 'kategori_pengeluaran.id as id_category', 'kategori_pengeluaran.name')
