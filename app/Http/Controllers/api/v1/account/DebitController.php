...
class DebitController extends Controller
{
    ...
    public function index()
    {
        $debit = DB::table('pemasukan')
            ->select('debit.id', 'pemasukan.category_id', 'debit.user_id', 'debit.nominal', 'debit.debit_date', 'debit.description', 'categories_debit.id as id_category', 'categories_debit.name as category_name')
            ->join('kategori_pemasukan', 'pemasukan.category_id', '=', 'categories_debit.id', 'LEFT')
