...
<body style="background-color: #394eea;">
<div id="app">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.html"><img src="{{ asset('assets/img/hmj.png') }}" alt="logo" width="35"><span style="font-size: 17px;"> UANG HMJ </span><span style="font-size: 10px;">Alpha</span></a>
                </div>
                <div class="sidebar-brand sidebar-brand-sm">
                    <a href="index.html"><img src="{{ asset('assets/img/hmj.png') }}" alt="logo" width="35""></a>
                </div>
